...
#   fluidRow(
#     column(12,
#            card_w_header("Filtered Pitch Data", tableOutput("pitch_table"))
#     )
#   )
# )
# 
...
#   })
#   
#   # ✅ Reactive to fetch filtered pitch data
#   pitch_data_filtered <- reactive({
#     req(input$selected_player, input$date_range)
#     player_id <- selected_pitcher()$player_id
#     start_date <- input$date_range[1]
#     end_date <- input$date_range[2]
#     
#     get_pitch_data(player_id, start_date, end_date)
#   })
#   
#   # ✅ Render filtered pitch data in table
